...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<supreme-big-input-action></supreme-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<supreme-big-input-action [disabled]="true"></supreme-big-input-action>';
    fixture = createHostComponent(template);
    expect(getButton().nativeElement.disabled).toBeTruthy();
  });

  it('should display icon if icon property is set', () => {
    const template = `<supreme-big-input-action [icon]="'delete'"></supreme-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template = `<supreme-big-input-action [label]="'delete'"></supreme-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template = `<supreme-big-input-action (action)="actionHandler()"></supreme-big-input-action>`;
    fixture = createHostComponent(template);
